...
/*
    ...
    - Rounding: If the integer is out of the 32-bit signed integer range [-2^31, 2^31 - 1], then round the integer to
        remain in the range. Specifically, integers less than -2^31 should be rounded to -2^31, and integers greater than
...
public class StringToInteger {
    ...
    /**
     * Converts a string to an integer, implementing the logic of the `atoi` function.
     *
     * @param s the input string
     * @return the converted integer
     */
    public static int myAtoi(String s) {
        int index = 0, result = 0, sign = 1, n = s.length();
